...
* `psdAdd()`: Addressed bug as described in [#136](https://github.com/fishR-Core-Team/FSA/issues/136)). Thanks to Dave Glover.
* `PSDlit`: Added info for Flier and Longear Sunfish.
* `wrAdd()`: Addressed bug similar to that for `psdAdd()`.
